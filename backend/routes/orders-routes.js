...
import { createOrder, getAllOrders, getUserOrders, getOrderById,  countTotalOrders, calculateTotalSales, calculateTotalSalesByDate, markOrderAsDelivered, markOrderAsPaid, getDashboardStats } from "../controllers/orders-controller.js";
...
router.route("/dashboard-stats").get(authenticate, authorizedAdmin, getDashboardStats)
