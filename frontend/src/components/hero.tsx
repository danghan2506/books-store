      ...
      <div className='flex items-center justify-center gap-12 flex-col xl:flex-row'>
        ...
        <div className='flex flex-1 flex-col pt-12 xl:pt-32'>
          <h1 className='text-[45px] leading-tight md:text-[55px] md:leading-[1.3] mb-4 font-bold max-w-[46rem]'>Find Your Next Favourite 
            <span className='inline-flex'><span className='inline-flex items-center justify-center p-5 h-16 w-16 bg-blue-500 text-white -rotate-[31deg] rounded-full'>
          ...
          <div className='mt-6'>
            <Link to={'/store'} className='btn text-[14px] font-[500] bg-blue-400 ring-1 ring-blue-400 text-tertiary px-7 py-2.5 rounded-full'>Explore now</Link>
          </div>
        </div>
        {/* right side */}
