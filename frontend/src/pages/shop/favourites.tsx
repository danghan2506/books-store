...
const Favourite = () => {
    const { favourites, userInfo } = useFavourites()
            ...
            <div className="pt-20 bg-gray-50 min-h-screen">
                <div className="mx-auto max-w-[1400px] px-4 lg:px-8 py-8">
                    <div className="flex flex-col items-center justify-center py-16">
                        ...
                        <h3 className="text-xl font-semibold text-gray-600 mb-2">Please login</h3>
                        <p className="text-gray-500 text-center max-w-md">
                            You need to be logged in to view your favourite products.
                        </p>
                    </div>
                </div>
            </div>
